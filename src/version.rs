...
fn epoch(s: &str) -> IResult<&str, Option<u64>> {
    opt(terminated(digit, char('!')))(s)
}

// parse the release segment
fn release(s: &str) -> IResult<&str, Vec<u64>> {
    separated_list1(char('.'), digit)(s)
}
